...
public class Modificar extends javax.swing.JFrame {
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
       ...
       String tema = txtTema.getText();
        oradorControler.modOrador(ora,nombre,apellido,email,tema);
        
        JOptionPane optionPane = new JOptionPane("Modificar Correctamente");
        optionPane.setMessageType(JOptionPane.INFORMATION_MESSAGE);
        JDialog dialog = optionPane.createDialog("Modificado");
        dialog.setAlwaysOnTop(true);
        dialog.setVisible(true);
        
        OradorView oraView = new OradorView();
        oraView.setVisible(true);
        oraView.setLocationRelativeTo(null);
        this.dispose();
    ...
    private void cargarDatos(int id) {
        this.ora = oradorControler.getOrador(id);  
        
        txtNombre.setText(ora.getNombre());
        txtApellido.setText(ora.getApellido());
        txtEmail.setText(ora.getEmail());
        txtTema.setText(ora.getTema());
    }
}
